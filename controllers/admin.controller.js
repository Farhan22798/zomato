...
exports.getCustomersForAdmin = asyncHandler(async (req, res) => {
...
exports.getOrdersforAdmin = asyncHandler(async (req, res) => {
    ...
    const result = await Order
        ...
        .populate("restaurant", "restaurantName email mobile")
...
exports.updateAdminRider = asyncHandler(async (req, res) => {
    riderUpload(req, res, async (err) => {
        ...
        if (req.file) {
            ...
            res.json({ message: "rider update success hhaa bhaiyya " })
        }
    })
})
